...
Additional features; notifications menu, search bar (to search for recent chats), message status (sent, unsent, and sending error), personalization (e.g. set user icon), online user count (to see how many and which group members are online at any given time - updates in real time)
...
<img width="900" alt="main" src="https://github.com/darshandesai1095/chat-app/assets/43254178/f50bcf3a-4d56-4294-b248-dde062a3b776">
